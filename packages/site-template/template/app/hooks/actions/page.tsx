...
export default function ActionsPage() {
  const hooks = siteData.reference.hooks.actions as unknown as Hook[];
  return (
    <div>
      <p className="page-eyebrow">Hooks</p>
      <h1 className="mb-2 text-3xl font-bold font-display">Actions</h1>
      <p className="page-desc">
        {hooks.length} action{hooks.length !== 1 ? 's' : ''} dispatched by this plugin.
      </p>
